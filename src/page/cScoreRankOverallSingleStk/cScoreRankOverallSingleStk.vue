...
export default {
  ...
  mounted() {
    ...
    this.currentStkCode=0
    this.targetStkCode=0
    this.showShort = "计入"
    this.getCScoreRank();
  ...
  methods: {
    ...
    getCScoreRank(){
      ...
      var targetStkCodeValue = 0;
      if (this.targetStkCode!=null && typeof(this.targetStkCode)=='string' && this.targetStkCode.length>0){
        targetStkCodeValue=this.targetStkCode
      }
      // console.log(targetStkCodeValue)
      // console.log(typeof(this.targetStkCode))
      axios({
        method:'post',
        url:'/getSingleCScoreRankGlobal',
        params:{
          high_limit_show:rankValue,
          table_name:"mt_list",
          short_flag:shortFlag,
          sort_flag:"top",
          stk_code:targetStkCodeValue,
          page_name:"单个股票查询"
        }
      }).then(response => {
        ...
        this.currentStkCode=targetStkCodeValue
...
<template>
  <div style="width: 2000px;">
    ...
    <vxe-input v-model="targetStkCode" placeholder="fCap数值" size="medium" type="string" style="left:70px;"></vxe-input><p style="display:none;">{{targetStkCode}}</p>
    <p>更新时间&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{updateTime}}</p>
    <p>是否计入涨停&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{showHighLimit}}</p>
    <p>是否计入看空&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{showShort}}</p>
    <p>当前查询股票&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{currentStkCode}}</p>
    <vxe-table 
    class="mytable-style"
    border="full" 
    height="1100"
