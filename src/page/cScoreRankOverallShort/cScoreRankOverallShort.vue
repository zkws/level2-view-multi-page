...
export default {
  ...
  methods: {
    ...
    getCScoreRank(){
      ...
      if (this.targetFCap!=null && typeof(this.targetFCap)=='string' && this.targetFCap.length>0){
        thresholdValue=this.targetFCap
      }
      // console.log(thresholdValue)
      // console.log(typeof(this.targetFCap))
      axios({
        method:'post',
        ...
        this.currentFCap=thresholdValue
...
<template>
  <div style="width: 2000px;">
    ...
    <vxe-input v-model="targetFCap" placeholder="fCap数值" size="medium" type="number" style="left:70px;"></vxe-input><p style="display:none;">{{targetFCap}}</p>
    <p>更新时间&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{updateTime}}</p>
    <p>是否计入涨停&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{showHighLimit}}</p>
    <p>是否计入看空&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{showShort}}</p>
    <p>当前fCap数值&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{currentFCap}}</p>
    <vxe-table 
    class="mytable-style"
    border="full" 
    height="1100"
